            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    try {
                        ...
                        //set Latitude
                        textView1.setText(Html.fromHtml("<font color='#0A0A47'><b>Latitude :</b><br></font>" + addresses.get(0).getLatitude()));

                        //set Longitude
                        textView2.setText(Html.fromHtml("<font color='#0A0A47'><b>Longitude :</b><br></font>" + addresses.get(0).getLongitude()));

                        //set Country Name
                        textView3.setText(Html.fromHtml("<font color='#0A0A47'><b>Country Name :</b><br></font>" + addresses.get(0).getCountryName()));

                        //set Locality
                        textView4.setText(Html.fromHtml("<font color='#0A0A47'><b>Locality :</b><br></font>" + addresses.get(0).getLocality()));

                        //get Address
                        textView5.setText(Html.fromHtml("<font color='#0A0A47'><b>Address :</b><br></font>" + addresses.get(0).getAddressLine(0)));
                    } catch (IOException e) {
